...
It is as PGR relations that the standard interpretation of OBO binary class-level relations are understood such as in formula (\ref{eq:cellobo}) above, according to \cite{OBO:RO}.

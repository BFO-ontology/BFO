...
\todo{introduce the meaning of <.,.> YES, WE DID IT ABOVE (a TQC is a tuple...)}
\begin{equation}
\begin{split}
...
\end{split}
\end{equation}
\todo{specify the meaning of ``within'' DID ABOVE}
...
%\todo{I THINK THIS SECTION IS NOT RELEVANT ANY LONGER AS IT CURRENTLY STANDS}
...
\todo{UPGRADE PROPOSAL TO LATEST TQC VERSION, i.e. remove continuantOf relation}
 \begin{equation}
\begin{split}

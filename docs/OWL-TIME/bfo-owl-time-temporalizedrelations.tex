...
So far we have not considered the PGR case. Being the standard interpretation of class level 
...
Histories can be related by occurrent parthood relations, such as every phase (temporal part) 

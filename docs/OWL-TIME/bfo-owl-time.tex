...
\include{bfo-owl-time-introduction}

\include{bfo-owl-time-problem}
...
\include{bfo-owl-time-temporalizedrelations}

\subsection*{Temporally Qualified Continuants (TQC)}

\include{bfo-owl-time-temporallyqualcontinuants}

\include{bfo-owl-time-discussion}
